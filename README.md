...
Amplify is an open-source app designed to empower users to take meaningful action in combating climate change. By selecting a climate campaign and identifying their representatives using their zip code, users can send letters of support, funded through donations, to amplify their voices and drive real change.
